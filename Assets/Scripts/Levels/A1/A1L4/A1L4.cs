...
public class A1L4 : MonoBehaviour
{
    ...
    private static void Part1Choice(A1L4 instance, int price, int bonus, GameObject priceObject, GameObject selectedObject)
    {
