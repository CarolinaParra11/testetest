...
public class A1L2 : MonoBehaviour
{
    ...
    private IEnumerator Part1b()
    {
        ...
        else if (PlayerManager.pm.englishCourse)
        {
            ...
            yield return new WaitForSeconds(1.5f);
            infoText.text = "Muito bem! Você ganhou 50 pontos extras para a bolonave, você fez o curso de inglês e vai conseguir chegar no hotel rapidamente!";
            FlavorManager.fm.ShowHidePanel(infoPanel, true);
            infoButton.onClick.AddListener(delegate
            {
    ...
    private IEnumerator taxiGo()
    {
        ...
        if (PlayerManager.pm.englishCourse)
        {
            ...
            infoText.text = "Por causa do seu bom inglês você chegará adiantado ao hotel sua corrida custou apenas 5 moedas e está pegando dicas com motorista!";
        ...
        else if (PlayerManager.pm.spanishCourse || PlayerManager.pm.koreanCourse)
        {
            ...
            BGA.SetActive(false); BGC.SetActive(true); BGB.SetActive(false);
            infoText.text = "O motorista deu muitas voltas para chegar ao hotel pois não lhe entendeu muito bem e sua corrida custou 6 moedas!";
            FlavorManager.fm.ShowHidePanel(optionPanel1, false);
            yield return new WaitForSeconds(0.5f);
            StartCoroutine(TimePanel());
    ...
    private IEnumerator Part2()
    {
        ...
        infoAvatarHotelText.text = "Acho que perdi meu carregador...";
        yield return new WaitForSeconds(4.0f);
        infoHotelText.text = "Que pena! Fique tranquilo você poderá comprar um novo na loja ao lado do hotel.";
        infoAvatarHotelText.text = "";
        yield return new WaitForSeconds(4.0f);

        infoAvatarHotelText.text = "Ok. Muito Obrigado!";
        yield return new WaitForSeconds(3.0f);
        infoHotelText.text = "Boa diversão garoto!";
        yield return new WaitForSeconds(4.0f);
    ...
    private IEnumerator goStore()
    {
        ...
        yield return new WaitForSeconds(2.50f);
        infoStoreText.text = "Sim! Compatível com seu aparelho nós temos este modelo que custa 6 moedas ";
        yield return new WaitForSeconds(2.50f);
        ...
        {
            infoText.text = "Você não tem o suficiente! Você poderá vender o ticket do jogo por 5 moedas ou você vai até o banco pedir um dinheiro mas pagará 2 moedas quando chegar no brasil.";
    ...
    private IEnumerator goBank()
    {
        ...
        yield return new WaitForSeconds(2.50f);
        FlavorManager.fm.ShowHidePanel(infoPanel, true);
        infoText.text = "Você conseguiu um empréstimo para comprar o carregador, porém terá que pagar 2 moedas de juros quando chegar ao Brasil.";
        infoButton.onClick.AddListener(delegate
        {
    ...
    private IEnumerator Part2c()
    {
        ...
        yield return new WaitForSeconds(1.50f);
        FlavorManager.fm.ShowHidePanel(infoPanel, true);
        infoText.text = infoText.text = "Parabéns! Você conseguiu resolver seu problema! Ufa você se preveniu e tinha o dinheiro guardado para esse momento. Sempre guarde moedas para esses momentos.Você ganhou 10 pontos extras para a bolonave.";
        yield return new WaitForSeconds(1.50f);
    ...
    private IEnumerator Part4()
    {
        ...
        p2Button1.onClick.AddListener(delegate { PanelButtonOneOption(this, 1, p2b1Price, p2b1Selected, p2b2Selected, p2b3Selected, p2Submit); });
        p2Button2.onClick.AddListener(delegate { PanelButtonOneOption(this, 2, p2b2Price, p2b2Selected, p2b1Selected, p2b3Selected, p2Submit); });
        p2Button3.onClick.AddListener(delegate { PanelButtonOneOption(this, 2, p2b3Price, p2b3Selected, p2b1Selected, p2b2Selected, p2Submit); });
    ...
    private IEnumerator Part5()
    {
        ...
        p1Button1.onClick.AddListener(delegate { PanelButtonOneOption(this, 7, p1b1Price, p1b1Selected, p1b2Selected, p1b3Selected, p1Submit); });
        p1Button2.onClick.AddListener(delegate { PanelButtonOneOption(this, 3, p1b2Price, p1b2Selected, p1b1Selected, p1b3Selected, p1Submit); });
    ...
    private static void PanelButtonOneOption(A1L2 instance, int price, GameObject priceObject, GameObject selectedObject, GameObject otherSelectedObject1, GameObject otherSelectedObject2, GameObject pSubmit)
    {
    ...
    private static void PanelButton(A1L2 instance, int price, int bonus, ref int totalPrice, TextMeshProUGUI totalPriceText, GameObject priceObject, GameObject selectedObject)
    {
        if (priceObject.activeSelf)
        {
            if (instance.totalCoins >= price)
    ...
    private static void PanelButton2(A1L2 instance, int price, int bonus, ref int totalPrice, TextMeshProUGUI totalPriceText, GameObject priceObject, GameObject selectedObject)
    {
        if (priceObject.activeSelf)
        {
            if (instance.totalCoins >= price)
