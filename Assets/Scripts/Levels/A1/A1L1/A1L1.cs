...
public class A1L1 : MonoBehaviour
{
    ...
    FlavorManager.fm.ShowHidePanel(infoPanel, true);
        infoText.text = "Você gosta muito de esportes e está se planejando para ir a um dos mais aguardados eventos esportivos do mundo, que será realizado na Coréia do Sul. Para isso, você deve, primeiro, programar sua viagem de avião. ' Você tem 9 moedas ' ";
    ...
    private IEnumerator Part1()
    {
        ...
        p1Button1.onClick.AddListener(delegate { PanelButtonOneOption(this, 5, p1b1Price, p1b1Selected, p1b2Selected, p1b3Selected, p1Submit); });
        p1Button2.onClick.AddListener(delegate { PanelButtonOneOption(this, 6, p1b2Price, p1b2Selected, p1b1Selected, p1b3Selected, p1Submit); });
    ...
    private IEnumerator Part1End()
    {
        ...
        infoText.text = "Agora você pode escolher como irá se programar para curtir sua viagem e assim, determinar como deseja separar seu orçamento para utilizar com diferentes finalidades. Você tem um total de 7 moedas! Escolha como quer separar este valor em cada uma das opções apresentadas:";
        counter = 1;
    ...
    private IEnumerator Part2()
    {
        ...
        if (counter < 4)
        {
            ...
            BGC.SetActive(true);
            BGB.SetActive(false);
            titleText.text = "Quantas moedas quer depositar no cofre? ' Você tem 7 moedas ' " ;

            safeButton1.onClick.AddListener(delegate { Part2Choice(this, safeButton1Selected, safeButton1.gameObject, 6); PlayerManager.pm.charger = (true); });
            safeButton2.onClick.AddListener(delegate { Part2Choice(this, safeButton2Selected, safeButton2.gameObject, 5); PlayerManager.pm.charger = (false); });
            safeButton3.onClick.AddListener(delegate { Part2Choice(this, safeButton3Selected, safeButton3.gameObject, 7); PlayerManager.pm.charger = (true); });
    ...
    private static void Part2Choice(A1L1 instance, Image selected, GameObject coin, int price)
    {
    ...
    private IEnumerator Part3()
    {
        ...
        p3Button1.onClick.AddListener(delegate { PlayerManager.pm.basketGame = true; PanelButtonOneOption(this, 5, p3b1Price, p3b1Selected, p3b2Selected, p3b3Selected, p3Submit); });
        p3Button2.onClick.AddListener(delegate { PlayerManager.pm.tenisGame = true;  PanelButtonOneOption(this, 6, p3b2Price, p3b2Selected, p3b1Selected, p3b3Selected, p3Submit); });
        p3Button3.onClick.AddListener(delegate { PlayerManager.pm.gym = true;        PanelButtonOneOption(this, 7, p3b3Price, p3b3Selected, p3b1Selected, p3b2Selected, p3Submit); });
    ...
    private IEnumerator Part4()
    {
        ...
        p4Button1.onClick.AddListener(delegate { PlayerManager.pm.koreanCourse = true; PanelButtonOneOption(this, 7, p4b1Price, p4b1Selected, p4b2Selected, p4b3Selected, p3Submit); });
        p4Button2.onClick.AddListener(delegate { PlayerManager.pm.spanishCourse = true; PanelButtonOneOption(this, 5, p4b2Price, p4b2Selected, p4b1Selected, p4b3Selected, p3Submit); });
        p4Button3.onClick.AddListener(delegate { PlayerManager.pm.englishCourse = true; PanelButtonOneOption(this, 6, p4b3Price, p4b3Selected, p4b1Selected, p4b2Selected, p3Submit); });
    ...
    private static void PanelButtonOneOption(A1L1 instance, int price, GameObject priceObject, GameObject selectedObject, GameObject otherSelectedObject1, GameObject otherSelectedObject2, GameObject pSubmit)
    {
    ...
    private static void PanelButton(A1L1 instance, int price, int bonus, ref int totalPrice, TextMeshProUGUI totalPriceText, GameObject priceObject, GameObject selectedObject)
    {
        if (priceObject.activeSelf)
        {
            if (instance.totalCoins >= price)
